    ...
    if (empty($username) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        if ($stmt->fetchColumn() > 0) {
            ...
            if ($stmt->execute(['username' => $username, 'email' => $email, 'password_hash' => $password_hash])) {
                $success = "Uspješno ste se registrirali! Sada se možete <a href='" . BASE_URL . "/login.php'>prijaviti</a>.";
            } else {
...
<head>
    ...
    <title>Registracija - Users Newsletters Dashboard</title>
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>/assets/css/style.css">
</head>
<body>
    <h1 class="main-login-title">Users Newsletters Dashboard</h1>
    ...
    <p>Već imaš račun? <a href="<?php echo BASE_URL; ?>/login.php" </textarea>Prijavi se ovdje</a></p>
</div>
