...
$stmt = $pdo->query("SELECT id, username, email, role, created_at, is_active FROM users ORDER BY id ASC");
$users = $stmt->fetchAll();
...
<div class="container">
    ...
    <?php endif; ?>
    <a href="add.php" class="button">Dodaj novog korisnika</a>
    <table>
        <thead>
            <tr>
                <th>ID</th>
        ...
        <tbody>
            <?php if (empty($users)): ?>
                <tr><td colspan="7">Nema registriranih korisnika.</td></tr>
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td><?php echo $user['is_active'] ? 'Aktivan' : 'Neaktivan'; ?></td>
                    <td>
                        <a href="edit.php?id=<?php echo $user['id']; ?>">Uredi</a> |
                        <a href="delete.php?id=<?php echo $user['id']; ?>" class="delete-confirm">Obriši</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            <?php endif; ?>
