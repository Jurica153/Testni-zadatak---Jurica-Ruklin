...
$stmt = $pdo->query("SELECT id, email, name, subscribed_at, is_active FROM subscribers ORDER BY id ASC");
...
<div class="container">
    <h2>Administracija Mailing Liste (Pretplatnici)</h2>
    <?php if (!empty($message)): ?>
        <p class="success-message"><?php echo $message; ?></p>
    <?php endif; ?>
    <a href="add.php" class="button">Dodaj novog pretplatnika</a>
    <a href="import.php" class="button" style="margin-left: 10px;">Uvezi pretplatnike (CSV)</a>
    <table>
        <thead>
            <tr>
                <th>ID</th>
        ...
        <tbody>
            <?php if (empty($subscribers)): ?>
                <tr><td colspan="6">Nema pretplatnika na mailing listi.</td></tr>
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td><?php echo $subscriber['is_active'] ? 'Aktivan' : 'Neaktivan'; ?></td>
                    <td>
                        <a href="delete.php?id=<?php echo $subscriber['id']; ?>" class="delete-confirm">Obriši</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            <?php endif; ?>
