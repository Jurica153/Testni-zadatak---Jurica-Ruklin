...
if ($newsletter_id > 0) {
    ...
    try {
        ...
        $pdo->commit();
        redirect('/admin/newsletters/index.php?message=Newsletter uspješno obrisan!');
    } catch (Exception $e) {
        $pdo->rollBack();
        redirect('/admin/newsletters/index.php?message=Greška prilikom brisanja newslettera: ' . urlencode($e->getMessage()));
    }
} else {
    redirect('/admin/newsletters/index.php?message=Nevažeći ID newslettera za brisanje.');
}
?>
