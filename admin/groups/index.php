...
$stmt = $pdo->query("SELECT id, name, description, created_at FROM groups ORDER BY id ASC");
...
<div class="container">
    <h2>Administracija Grupa</h2>
    <?php if (!empty($message)): ?>
        <p class="success-message"><?php echo $message; ?></p>
    <?php endif; ?>
    <a href="add.php" class="button">Dodaj novu grupu</a>
    <table>
        <thead>
            <tr>
                <th>ID</th>
        ...
        <tbody>
            <?php if (empty($groups)): ?>
                <tr><td colspan="5">Nema kreiranih grupa.</td></tr>
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit.php?id=<?php echo $group['id']; ?>">Uredi</a> |
                        <a href="delete.php?id=<?php echo $group['id']; ?>" class="delete-confirm">Obriši</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            <?php endif; ?>
