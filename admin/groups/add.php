    ...
    if (empty($name)) {
        ...
        if ($stmt->fetchColumn() > 0) {
            ...
            if ($stmt->execute(['name' => $name, 'description' => $description])) {
                redirect('/admin/groups/index.php?message=Grupa uspješno dodana!');
            } else {
                $error = "Greška prilikom dodavanja grupe.";
            }
        }
    }
}
...
<div class="container">
    <h2>Dodaj novu grupu</h2>
    <?php if (!empty($error)): ?>
        <p class="error-message"><?php echo htmlspecialchars($error); ?></p>
    <?php endif; ?>
    <form action="<?php echo BASE_URL; ?>/admin/groups/add.php" method="POST">
        ...
        <a href="<?php echo BASE_URL; ?>/admin/groups/index.php" class="button" style="margin-left: 10px;">Natrag na popis</a>
    </form>
</div>
